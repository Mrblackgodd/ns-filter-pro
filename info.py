...
BOT_TOKEN = environ.get('BOT_TOKEN', '5872847438:AAHoiBi7QB1exRJsbv5FPY1fpki-sc9HkFM')
...
# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '2034654684').split()]
...
# Channels
INDEX_CHANNELS = [int(index_channels) if id_pattern.search(index_channels) else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001943196163').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001818522365')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001748572062'))

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://smnehal969797:nehalsingh969797@cluster0.4f8dn26.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get("SHORTLINK_API", "zKMfImhgnFVTWBp9w00ChMHseBF2")
